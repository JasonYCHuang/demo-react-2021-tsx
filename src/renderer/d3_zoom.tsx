    ...
    <>
      ...
      >
        {(zoom: {
          ...
          isDragging: any;
          containerRef: React.LegacyRef<SVGSVGElement> | undefined;
          toString: () => string | undefined;
          dragStart: React.MouseEventHandler<SVGRectElement> | undefined;
          dragMove: React.MouseEventHandler<SVGRectElement> | undefined;
          dragEnd: React.MouseEventHandler<SVGRectElement>;
          scale: (arg0: {
            scaleX: number;
            scaleY: number;
            point?: any;
          }) => void;
          toStringInvert: () => string | undefined;
          center: React.MouseEventHandler<HTMLButtonElement> | undefined;
          reset: React.MouseEventHandler<HTMLButtonElement> | undefined;
          clear: React.MouseEventHandler<HTMLButtonElement> | undefined;
        }) => (
          <div className="relative">
            ...
            >
              ...
              <rect
                ...
                onMouseLeave={(e) => {
                  if (zoom.isDragging) zoom.dragEnd(e);
                }}
                onDoubleClick={(event) => {
